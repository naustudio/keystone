...
function filecustom (list, path, options) {
	...
	filecustom.super_.call(this, list, path, options);
}
filecustom.properName = 'FileCustom';
util.inherits(filecustom, FieldType);

/**
 * Registers the field on the List's Mongoose Schema.
 */
filecustom.prototype.addToSchema = function (schema) {
 ...
 * Uploads a new file
 */
filecustom.prototype.upload = function (item, file, callback) {
	var field = this;
 ...
 */
filecustom.prototype.reset = function (item) {
	var value = {};
	Object.keys(this.storage.schema).forEach(function (path) {
		value[path] = null;
	});
...
filecustom.prototype.remove = function (item) {
 ...
 */
filecustom.prototype.format = function (item) {
 ...
 */
filecustom.prototype.isModified = function (item) {
	var modified = false;
 ...
 */
filecustom.prototype.validateInput = function (data, callback) {
 ...
 */
filecustom.prototype.validateRequiredInput = function (item, data, callback) {
 ...
 */
filecustom.prototype.updateItem = function (item, data, files, callback) {
	// Process arguments
